...
<body>
  <div class="app-layout">
    ...
    <div class="main-content">
      <header class="topbar">
        <button class="hamburger" onclick="toggleSidebar()" aria-label="Buka menu"><i data-lucide="menu"></i></button>
        <div class="topbar-title" style="display:flex;align-items:center;gap:8px;"><i data-lucide="<?= $currentNav['icon'] ?>" style="width:16px;height:16px;color:var(--emerald);"></i> <?= $currentNav['label'] ?></div>
